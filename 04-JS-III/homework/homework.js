...
function incrementarPorUno(array) {
  ...
  // y devuelve el array
  // Tu código:
  return array.map(function(integer){
    return integer += 1;
  });
}
...
function cuentoElementos(arreglo){
  ...
  //Escribe tu código aquí
  return arreglo.filter(function(int){
    return int > 18;
  }).length;
}
...
function mesesDelAño(array) {
  ...
  let arr = [];
    for (let i = 0; i < array.length; i++){
      ...
      || array[i] === "Noviembre"){ 
      arr.push(array[i])}}
  if (arr.includes("Enero") !== true || arr.includes("Marzo") !== true || arr.includes("Noviembre") !== true){
